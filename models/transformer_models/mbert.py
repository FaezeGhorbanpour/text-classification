...
class mBert(nn.Module):
    def __init__(self, embedding, ):
        ...
        self.bert = AutoModel.from_pretrained("/home/faeze/huggingface_models/bert-base-multilingual-uncased")
...
class mBertClassifier(TransformerModel):
    def __init__(self, embedding):
        super().__init__(embedding)
        self.model_name = 'mbert'
        self.embedding = embedding
        self.tokenizer = AutoTokenizer.from_pretrained("/home/faeze/huggingface_models/bert-base-multilingual-uncased")
